...
export const permissionModules: PermissionModuleDefinition[] = [
  ...
  { key: "revenue_registration", label: "Revenue Registration", description: "Revenue module access.", actions: ["view", "create", "edit", "create_request", "delete", "manage", "export", "import", "downloadTemplate", "viewImportHistory"] },
