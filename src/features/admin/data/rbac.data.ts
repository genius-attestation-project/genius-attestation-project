...
export const sidebarNavigation: NavigationItemDefinition[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: "Countries",
        href: "/dashboard/master-configuration/countries",
        icon: LayoutDashboard,
        menuPermission: "menu.master-configuration.countries",
        pagePermission: "master_configuration.view",
      },
      {
        label: "States",
        href: "/dashboard/master-configuration/states",
        icon: LayoutDashboard,
        menuPermission: "menu.master-configuration.states",
        pagePermission: "master_configuration.view",
      },
      {
        label: "Cities",
        href: "/dashboard/master-configuration/cities",
        icon: LayoutDashboard,
        menuPermission: "menu.master-configuration.cities",
        pagePermission: "master_configuration.view",
      },
      {
        label: "Embassy List",
      ...
      {
        label: "Payment Modes",
        href: "/dashboard/master-configuration/payment-modes",
        icon: BadgeDollarSign,
        menuPermission: "menu.master-configuration.payment-modes",
        pagePermission: "master_configuration.view",
      },
      {
        label: "Payment Status",
        href: "/dashboard/master-configuration/payment-status",
        icon: BadgeDollarSign,
      ...
      },
      {
        ...
        icon: CalendarDays,
        menuPermission: "menu.master-configuration.holiday-calendar",
        pagePermission: "master_configuration.view",
      },
      {
        label: "Working Days",
        href: "/dashboard/master-configuration/working-days",
        icon: CalendarDays,
        menuPermission: "menu.master-configuration.working-days",
        pagePermission: "master_configuration.view",
      },
      {
        label: "Currency",
        href: "/dashboard/master-configuration/currency",
        icon: BadgeDollarSign,
        menuPermission: "menu.master-configuration.currency",
        pagePermission: "master_configuration.view",
      },
      {
        label: "Tax Settings",
        href: "/dashboard/master-configuration/tax-settings",
        icon: BadgeDollarSign,
        menuPermission: "menu.master-configuration.tax-settings",
        pagePermission: "master_configuration.view",
      },
      {
        label: "Notification Templates",
        href: "/dashboard/master-configuration/notification-templates",
        icon: Settings2,
        menuPermission: "menu.master-configuration.notification-templates",
        pagePermission: "master_configuration.view",
      },
      {
        label: "Email Templates",
        href: "/dashboard/master-configuration/email-templates",
        icon: Settings2,
        menuPermission: "menu.master-configuration.email-templates",
        pagePermission: "master_configuration.view",
      },
      {
        label: "SMS Templates",
        href: "/dashboard/master-configuration/sms-templates",
        icon: Settings2,
        menuPermission: "menu.master-configuration.sms-templates",
        pagePermission: "master_configuration.view",
      },
      {
        label: "WhatsApp Templates",
        href: "/dashboard/master-configuration/whatsapp-templates",
        icon: Settings2,
        menuPermission: "menu.master-configuration.whatsapp-templates",
        pagePermission: "master_configuration.view",
      },
      {
        label: "Document Status",
        href: "/dashboard/master-configuration/document-status",
        icon: FileSearch,
        menuPermission: "menu.master-configuration.document-status",
        pagePermission: "master_configuration.view",
      },
      {
      ...
      {
        label: "BM Status",
        href: "/dashboard/master-configuration/bm-status",
        icon: UserCheck,
        menuPermission: "menu.master-configuration.bm-status",
        pagePermission: "master_configuration.view",
      },
      {
      ...
      },
      {
        ...
        href: "/dashboard/master-configuration/user-designations",
        icon: Users,
        menuPermission: "menu.master-configuration.user-designations",
        pagePermission: "master_configuration.view",
      },
      {
        label: "General Settings",
        href: "/dashboard/master-configuration/general-settings",
        icon: Settings2,
        menuPermission: "menu.master-configuration.general-settings",
        pagePermission: "master_configuration.view",
      },
    ],
  },
