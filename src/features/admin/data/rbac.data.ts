...
export const permissionModules: PermissionModuleDefinition[] = [
  ...
  { key: "revenue_registration", label: "Revenue Registration", description: "Revenue module access.", actions: ["view", "create", "edit", "create_request", "movement_request", "delete", "manage", "export", "import", "downloadTemplate", "viewImportHistory"] },
...
export const defaultRoleDefinitions = [
  ...
  },
  {
    ...
    permissions: [
      ...
      "pending_approval.view",
      "pending_approval.edit",
      "movement_approval.view",
      "movement_approval.create",
      "revenue_registration.movement_request",
      "edit_request.view",
      "edit_request.approve",
      "edit_request.reject",
