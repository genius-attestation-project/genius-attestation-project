...
import { PERMISSION_CATALOG, type CatalogModule } from "@/features/admin/data/permission-catalog.data";
...
export function UserAccessManagement() {
  ...
  function toggleAllModulePermissions(moduleDef: CatalogModule, enable: boolean) {
    if (!selectedUserId) return;
