...
export const AdvanceTable: React.FC<AdvanceTableProps> = ({
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between bg-blue-50/80 px-3 py-1.5 rounded-xl dark:bg-blue-950/40 border border-blue-100 dark:border-blue-900/30">
        ...
        <table className="w-full text-left text-xs border-collapse">
          <thead>
            <tr className="border-b border-slate-200/80 bg-slate-50/80 text-slate-600 dark:border-white/10 dark:bg-white/5 dark:text-slate-400 font-bold uppercase tracking-wider text-[11px]">
              ...
              <th className="py-2.5 px-3">Registrar / Collected By</th>
            ...
            {items.length === 0 ? (
              <tr>
                <td colSpan={6} className="py-6 text-center text-slate-400 dark:text-slate-500 italic">
                  No cash advances recorded in this period.
                </td>
              </tr>
            ) : (
              items.map((item, index) => (
                ...
                >
                  ...
                  <td className="py-2.5 px-3 font-bold text-blue-600 dark:text-blue-400 whitespace-nowrap">
                    {item.invoiceNumber}
                  </td>
          ...
          {items.length > 0 && (
            <tfoot>
              <tr className="border-t-2 border-slate-200 bg-slate-50/90 font-black dark:border-white/10 dark:bg-white/5">
                ...
                <td className="py-2.5 px-3 text-right text-blue-700 dark:text-blue-300">
