          ...
          <div className="w-full max-w-xl max-h-[90vh] overflow-y-auto rounded-3xl bg-white p-6 shadow-2xl dark:bg-[#0f1115] dark:border dark:border-white/10 space-y-6">
            <div className="flex items-center justify-between border-b border-slate-200/80 pb-4 dark:border-white/10">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Assign each tracking number to ONE Sub Package from this office&apos;s assigned list.
                </p>
              </div>
              <button
            ...
            <form onSubmit={handleTransferToSubPackageSubmit} className="space-y-4">
              <div className="max-h-64 overflow-y-auto divide-y divide-slate-100 rounded-2xl border border-slate-200/60 p-3 space-y-3 dark:divide-white/10 dark:border-white/10">
                {selectedTrackingNumbers.map((tNum) => (
                  <div key={tNum} className="pt-2 first:pt-0">
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-slate-200 bg-white p-2.5 text-xs font-semibold text-slate-900 focus:border-blue-500 focus:outline-none dark:border-white/10 dark:bg-[#0f1115] dark:text-white"
                    >
