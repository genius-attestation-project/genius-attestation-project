        ...
        <div className="grid gap-6 xl:grid-cols-[1fr_auto]">
          <div className="grid gap-4">
            <div className="flex flex-wrap items-end gap-4">
              <div className="flex min-w-[200px] items-center gap-4 rounded-2xl border border-emerald-200/70 bg-white p-4 shadow-sm dark:border-emerald-500/20 dark:bg-slate-950/60">
                ...
                <div className="pr-2">
                  ...
                  <p className="text-[10px] leading-tight text-soft mt-0.5">
