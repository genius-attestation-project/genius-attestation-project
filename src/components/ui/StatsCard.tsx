...
export function StatsCard({
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-[color:var(--border)] bg-white p-5 shadow-[var(--shadow-card)] transition duration-200 hover:-translate-y-0.5 hover:shadow-md dark:bg-white/5">
      <div
        className={cn(
      ...
      <div className="relative flex items-start justify-between gap-4">
        <div>
          ...
          <strong className="mt-3 block text-2xl font-semibold tracking-tight">{value}</strong>
        </div>
